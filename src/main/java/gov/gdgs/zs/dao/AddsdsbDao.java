...
public class AddsdsbDao extends BaseJdbcDao  implements IAddsdsbDao{
	...
	public String AddSwsjbqkb( Map <String,Object> obj){
		...
		sb.append("  ( id,jg_id,nd,jgxz_dm,frdbxm,czrs,hhrs,ryzs,zyzcswsrs,zczj,yysr,zcze,srze,lrze,cs_dm,");
		sb.append(" wths,sbrq,ztbj,tianbiaoren,suozhang)");
		sb.append("values ( :id,:jg_id,:nd,:jgxz_dm,:frdbxm,:czrs,:hhrs,:ryzs,:zyzcswsrs,:zczj,:yysr,:zcze,");	
	...
	public void UpdateSwsjbqkb(Map <String,Object> obj) {
		 StringBuffer sb = new StringBuffer("update "
				+ Config.PROJECT_SCHEMA + "zs_sdsb_swsjbqk ");
		sb.append(" set jg_id=:jg_id,nd=:nd,jgxz_dm=:jgxz_dm,frdbxm=:frdbxm,czrs=:czrs,hhrs=:hhrs,ryzs=:ryzs,");	
	...
	public Map<String, Object> getSwsjbqkb(int page, int pageSize,
	...
	public Map<String, Object> getLrze() {
		String sql = "select a.* from "+Config.PROJECT_SCHEMA+"zs_cwbb_lrgd a where jg_id=68  and timevalue='1' and nd=( select max(nd) as mnd from zs_cwbb_lrgd where  timevalue='1')";

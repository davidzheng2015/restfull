...
public class SPDao extends BaseDao{
	 ...
	 * @return
	 */
	public Map<String,Object> wspmxcx(int pn,int ps,int uid,int lclxid,Map<String,Object> qury){
		Condition condition = new Condition();
		StringBuffer sb = new StringBuffer();
		if(lclxid==13||lclxid==14||lclxid==15||lclxid==20||lclxid==43||lclxid==44){
			String zdm="FZY_ID";
	...
	public List<Map<String, Object>> getFzyswsBa(String sfzh) {
		StringBuffer sb = new StringBuffer();
		sb.append(" select d.ZTBJ,e.spyj,a.RYZT_DM,a.ID  ");

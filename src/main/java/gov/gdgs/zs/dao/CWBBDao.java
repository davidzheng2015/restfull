   ...
   //利润表
	...
	//现金流量表
      ...
      public Map<String,Object> getJzywtjbById(String id){
			...
			sb.append(" CONCAT(FORMAT((a.HSQJJE_HS-a.HSQJJE_HS0)/a.HSQJJE_HS0*100,2),'%') HSZZB2,CONCAT(FORMAT((a.HSQJJE_JE-a.HSQJJE_JE0)/a.HSQJJE_JE0*100,2),'%') JEZZB2,");
			...
			sb.append(" CONCAT(FORMAT((a.TZYNSDSE_HS-a.TZYNSDSE_HS0)/a.TZYNSDSE_HS0*100,2),'%') HSZZB3,CONCAT(FORMAT((a.TZYNSDSE_JE-a.TZYNSDSE_JE0)/a.TZYNSDSE_JE0*100,2),'%') JEZZB3,");
			...
			sb.append(" CONCAT(FORMAT((a.TJYNSDSE_HS-a.TJYNSDSE_HS0)/a.TJYNSDSE_HS0*100,2),'%') HSZZB4,CONCAT(FORMAT((a.TJYNSDSE_JE-a.TJYNSDSE_JE0)/a.TJYNSDSE_JE0*100,2),'%') JEZZB4,");
			...
			sb.append(" CONCAT(FORMAT((a.MBKSJE_HS-a.MBKSJE_HS0)/a.MBKSJE_HS0*100,2),'%') HSZZB5,CONCAT(FORMAT((a.MBKSJE_JE-a.MBKSJE_JE0)/a.MBKSJE_JE0*100,2),'%') JEZZB5,");
			...
			sb.append(" CONCAT(FORMAT((a.CCSSKC_HS-a.CCSSKC_HS0)/a.CCSSKC_HS0*100,2),'%') HSZZB6,CONCAT(FORMAT((a.CCSSKC_JE-a.CCSSKC_JE0)/a.CCSSKC_JE0*100,2),'%') JEZZB6,");
			...
			sb.append(" CONCAT(FORMAT((a.TDZZSQSJZ_HS-a.TDZZSQSJZ_HS0)/a.TDZZSQSJZ_HS0*100,2),'%') HSZZB7,CONCAT(FORMAT((a.TDZZSQSJZ_JE-a.TDZZSQSJZ_JE0)/a.TDZZSQSJZ_JE0*100,2),'%') JEZZB7,");
			...
			sb.append(" CONCAT(FORMAT((a.QTJZ_HS-a.QTJZ_HS0)/a.QTJZ_HS0*100,2),'%') HSZZB8,CONCAT(FORMAT((a.QTJZ_JE-a.QTJZ_JE0)/a.QTJZ_JE0*100,2),'%') JEZZB8,");
			...
			sb.append(" CONCAT(FORMAT((a.GXJSQYRDQZYW_HS-a.GXJSQYRDQZYW_HS0)/a.GXJSQYRDQZYW_HS0*100,2),'%') HSZZB9,CONCAT(FORMAT((a.GXJSQYRDQZYW_JE-a.GXJSQYRDQZYW_JE0)/a.GXJSQYRDQZYW_JE0*100,2),'%') JEZZB9,");
			...
			sb.append(" CONCAT(FORMAT((a.QYZXSWDESKJSJZYW_HS-a.QYZXSWDESKJSJZYW_HS0)/a.QYZXSWDESKJSJZYW_HS0*100,2),'%') HSZZB10,CONCAT(FORMAT((a.QYZXSWDESKJSJZYW_JE-a.QYZXSWDESKJSJZYW_JE0)/a.QYZXSWDESKJSJZYW_JE0*100,2),'%') JEZZB10,");
			...
			sb.append(" CONCAT(FORMAT((a.YFFJJKCJZYW_HS-a.YFFJJKCJZYW_HS0)/a.YFFJJKCJZYW_HS0*100,2),'%') HSZZB11,CONCAT(FORMAT((a.YFFJJKCJZYW_JE-a.YFFJJKCJZYW_JE0)/a.YFFJJKCJZYW_JE0*100,2),'%') JEZZB11,");
			sb.append(" a.QT_HS0,a.QT_JE0,a.QT_HS,a.QT_JE,");
			sb.append(" (a.QT_HS-a.QT_HS0) AS HSZJE12,(a.QT_JE-a.QT_JE0) AS JEZJE12,");
			sb.append(" CONCAT(FORMAT((a.QT_HS-a.QT_HS0)/a.QT_HS0*100,2),'%') HSZZB12,CONCAT(FORMAT((a.QT_JE-a.QT_JE0)/a.QT_JE0*100,2),'%') JEZZB12,");
    ...
    //经营规模统计表
      ...
      public Map<String,Object> getJygmtjbById(String id){
			...
			sb.append("	CONCAT(FORMAT((a.BNSRZE_HJ-a.SNSRZE)/a.SNSRZE*100,2),'%') AS ZZB,a.TBR,a.SZ");
